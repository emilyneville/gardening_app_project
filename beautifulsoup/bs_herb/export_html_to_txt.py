...
## https://www.ufseeds.com/vegetables?sz=72&start=72
    ...
    while page_num <= 2: 
        product_page = requests.get(f"https://www.ufseeds.com/herbs?start={product_num}&sz=72")
...
for key, value in all_the_veg.items():
    ...
    try:
        ...
        path = f'/home/hackbright/src/project/beautifulsoup/bs_herb/bs_herb_files/{key}.txt'
